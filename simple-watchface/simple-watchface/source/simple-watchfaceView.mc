...
class SimpleWatchfaceView extends WatchUi.WatchFace {
    ...
    function onUpdate(dc as Dc) as Void {
        ...
        var timeString = Lang.format("$1$:$2$", [timeAndDate.hour, timeAndDate.min.format("%02d")]);
        var dateString = Lang.format("$1$-$2$-$3$", [timeAndDate.year, timeAndDate.month.format("%02d"), timeAndDate.day.format("%02d")]);
